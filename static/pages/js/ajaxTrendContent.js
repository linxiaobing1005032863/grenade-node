...
$.ajax({
    ...
    type: "GET",
    beforeSend: function () {
        $(".noticeContent").html('<img src="/images/loading.gif" class="loading img-responsive">');
    },
    success: function (res) {
        if (res.code == 200) {
            $(".noticeContent").empty();
            $(".noticeContent").html(
                '<p class="way"><span class="glyphicon glyphicon-home"></span>&nbsp;&nbsp;当前位置：<a href="../index.html">首页</a>&nbsp;&gt;&nbsp;<a href="trendIndex.html">公司动态</a>&nbsp;&gt;&nbsp;${res.data.title}</p>'.format({
